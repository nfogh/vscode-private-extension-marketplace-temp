...
\t// List of registries containing private extensions.
\t// Each item should have a "name", a "registry" URL, and optionally a "query" to
\t// filter which extensions are shown.
\t// For NMP type registries, see https://www.npmjs.com/package/npm-registry-fetch#fetch-opts 
\t// for extra options including authentication.
\t"registries": [
\t],
