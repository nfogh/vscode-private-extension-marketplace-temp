...
export abstract class ExtensionsListWebviewProvider implements WebviewViewProvider, Disposable {
    ...
    public async refresh(): Promise<void> {
        ...
        if (isFirstLoad) {
            ...
            await this.view.webview.postMessage({ type: 'setLoading', loading: true });
        }
    ...
    private getMaxExtensionsShown(): number {
        return vscode.workspace.getConfiguration('privateExtensions').get<number>('maxExtensionsShown', 100);
    }
